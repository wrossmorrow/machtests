...
The script is run in cronjob on each seaver and test results are logged to sqlite and InfluxDB which is part of the TICK stack.
...
Sqlite3 software and starter database
    To build starter database navigate to db_scripts folder and enter ./create_db.sh
